...
template class ScalarizedGrVariables<double, false>;
template class ScalarizedGrVariables<DataVector, false>;
template class ScalarizedGrVariables<double, true>;
template class ScalarizedGrVariables<DataVector, true>;

}  // namespace detail

template <typename GrSolution, bool HasMhd>
PUP::able::PUP_ID ScalarizedGr<GrSolution, HasMhd>::my_PUP_ID = 0;  // NOLINT

}  // namespace sgb::Solutions

// Instantiate implementations for common variables
template class Xcts::Solutions::CommonVariables<
    double, typename sgb::Solutions::detail::ScalarizedGrVariables<
                double, false>::Cache>;
template class Xcts::Solutions::CommonVariables<
    DataVector, typename sgb::Solutions::detail::ScalarizedGrVariables<
...
#define INSTANTIATE_GR(_, data) \
  template class sgb::Solutions::ScalarizedGr<STYPE(data), false>;
#define INSTANTIATE_GRMHD(_, data) \
  template class sgb::Solutions::ScalarizedGr<STYPE(data), true>;
