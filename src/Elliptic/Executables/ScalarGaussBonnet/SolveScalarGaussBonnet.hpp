...
#include "Elliptic/Systems/ScalarGaussBonnet/BoundaryConditions/Factory.hpp"
...
struct Metavariables {
  ...
  static constexpr Options::String help{"Find the solution to an SGB problem."};
  ...
  using observe_fields = tmpl::append<
      ...
      typename hydro_quantities_compute::tags_list,
  ...
  using const_global_cache_tags =
      tmpl::list<domain::Tags::RadiallyCompressedCoordinatesOptions,
                 sgb::Tags::Epsilon2, sgb::Tags::Epsilon4,
                 sgb::Tags::RolloffLocation, sgb::Tags::RolloffRate>;
  ...
  struct factory_creation
    ...
    using factory_classes = tmpl::map<
        ...
        tmpl::pair<elliptic::BoundaryConditions::BoundaryCondition<volume_dim>,
                   sgb::BoundaryConditions::standard_boundary_conditions>,
