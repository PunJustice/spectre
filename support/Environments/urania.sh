...
spectre_load_modules() {
    ...
    export SPECTRE_HOME=/u/pjn/gitrepos/spectre/combined_fork
    source /u/guilara/repos/spectre/env/bin/activate
}
...
spectre_run_cmake() {
    ...
    -D CHARM_ROOT=$CHARM_ROOT -D CMAKE_BUILD_TYPE=Release -D DEBUG_SYMBOLS=OFF \
    -D BUILD_SHARED_LIBS=ON \
    -D MEMORY_ALLOCATOR=JEMALLOC \
    -D BUILD_PYTHON_BINDINGS=ON \
    -D Catch2_DIR=/u/guilara/repos/Catch2/install_dir/lib64/cmake/Catch2 \
    -D MPI_C_COMPILER=/mpcdf/soft/SLE_15/packages/skylake/impi/\
    gcc_11-11.2.0/2021.7.1/bin/mpigcc \
    -D MPI_CXX_COMPILER=/mpcdf/soft/SLE_15/packages/skylake/impi/\
    gcc_11-11.2.0/2021.7.1/bin/mpig++ \
    -D MPI_Fortran_COMPILER=/mpcdf/soft/SLE_15/packages/skylake/impi/\
    gcc_11-11.2.0/2021.7.1/bin/mpigfortran \
    -D SPEC_ROOT=/u/guilara/repos/spec -D MACHINE=Urania \
